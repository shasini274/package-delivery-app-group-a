 ...
 * Use the [PackageDetailFragment.newInstance] factory method to
...
class PackageDetailFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val root = inflater.inflate(R.layout.fragment_package_detail, container, false)


       val args: PackageDetailFragmentArgs by navArgs()
